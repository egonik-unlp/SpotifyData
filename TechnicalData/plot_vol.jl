...
using JSON, Plots, CSV, DataFrames, Dates, StatsPlots

# ╔═╡ a242cad2-5e64-4dbf-ae98-dd92252a5805
js = JSON.parsefile("ConnectVolumeControl.json")

# ╔═╡ ae5c1f91-351a-4647-8d53-0ee3f8260b05
data = [(time = DateTime(node["timestamp_utc"], dateformat"yyyy-m-dTH:M:S.sZ") ,volume = node["message_volume"] ) for node in js]
...
@df df scatter(:time, :volume)

# ╔═╡ 52863e8e-d708-46d3-a0c9-1311740cadd4
@df filter(x-> x.time .>= (today() - Dates.Day(8)), df) scatter(:time, :volume)
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "6f6bbb11f91737956e82f54da9825da64c405280"
